---
description: 整理 workmap——对照最新方向与进展刷新 heading、清理失效信号
---

对照当前会话的最新方向与进展，整理你的 workmap：

1. 先用 workmap view 查看当前 workmap。
...
6. 用一次 workmap update（必要时配合 remove）完成全部调整；若整张 workmap 已与会话无关，用 clear。

不要新增"我刚整理了 workmap"之类的节点；只保留对当前方向有实质影响的信号。
